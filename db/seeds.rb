...
# 3) Companies
  # companies = Company.create([{ name: 'OSKAR WEHR', country_id: countries[2]},
  #                           { name: 'OAL', country_id: countries[4]},
  #                           { name: 'Ukraine Companies', country_id: countries[1]},
  #                           ])
# 3) Holidays
...
# 4) CountriesHolidays
  ...
  #                       {country_id: countries[1], holiday_id: holidays[2] },
  #                       {country_id: countries[2], holiday_id: holidays[3] },
  #                       {country_id: countries[3], holiday_id: holidays[4] },
  #                       ])
...
# 5) Person
  ...
  #                         {name: "Name3 Family3 Middle3", email: "name3@domain2.com", country_id: countries[1], company_id: companies[1]},
  #                         {name: "Name4 Family4 Middle4", email: "name4@domain2.com", country_id: countries[1], company_id: companies[1]},
  #                         {name: "Name5 Family5 Middle5", email: "name5@domain2.com", country_id: countries[2], company_id: companies[2]},
  #                         {name: "Name6 Family6 Middle6", email: "name6@domain6.com", country_id: countries[3], company_id: companies[2]},
  #                         {name: "Name7 Family7 Middle7", email: "name7@domain6.com", country_id: countries[3], company_id: companies[3]}
  #                       ])
# # 6) CompaniesPerson
