...
ActiveRecord::Schema.define(version: 20_190_917_115_305) do
  ...
  create_table 'companies_holidays', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[company_id holiday_id], name: 'index_companies_holidays_on_company_id_and_holiday_id', unique: true
  ...
  create_table 'companies_people', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.bigint 'company_id'
    t.index %w[company_id person_id], name: 'index_companies_people_on_company_id_and_person_id', unique: true
  ...
  create_table 'countries_holidays', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[country_id holiday_id], name: 'index_countries_holidays_on_country_id_and_holiday_id', unique: true
  ...
  create_table 'dates_holidays', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.date 'date'
    t.index %w[holiday_id day month year], name: 'index_dates_holidays_on_holiday_id_and_day_and_month_and_year', unique: true
  ...
  create_table 'email_cards', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[email_id postcard_id], name: 'index_email_cards_on_email_id_and_postcard_id', unique: true
  ...
  create_table 'email_texts', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8', force: :cascade do |t|
    ...
    t.index %w[email_id cardtext_id], name: 'index_email_texts_on_email_id_and_cardtext_id', unique: true
  ...
  create_table 'emails', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8', force: :cascade do |t|
    ...
    t.index %w[holiday_id person_id year], name: 'index_emails_on_holiday_id_and_person_id_and_year', unique: true
  ...
  create_table 'postcards', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8', force: :cascade do |t|
    ...
    t.binary 'image', limit: 4_294_967_295
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
